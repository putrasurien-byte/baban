...
const skills = {
  frontend: [
    ...
    { name: 'kimia', level: 88 },
    { name: 'biologi', level: 79 },
    { name: 'bahasa indonesia', level: 75 },
  ],
  backend: [
    { name: 'bahasa inggris', level: 84 },
    { name: 'bahasa arab', level: 73 },
    { name: 'ekonomi', level: 81 },
    { name: 'geografi', level: 82 },
    { name: 'sejarah', level: 80 },
  ],
  tools: [
    { name: 'fikih', level: 88 },
    { name: 'al quran hadits', level: 80 },
    { name: 'akidah', level: 86 },
    { name: 'ski', level: 85 },
    { name: 'pkn', level: 82 },
  ],
};
